...
import SideBar from './components/layout/main-wrapper/side-bar.vue'
...
@icon-url-home: "https://icongr.am/entypo/home.svg?size=128&color=ffffff";
@icon-url-queue: "https://icongr.am/entypo/add-to-list.svg?size=128&color=ffffff";
@icon-url-song: "https://icongr.am/entypo/music.svg?size=128&color=ffffff";
@icon-url-settings: "https://icongr.am/entypo/cog.svg?size=128&color=ffffff";
...
.menu{
	...
	ul{
		...
		li{
			...
			&.icon-home{
				background-image:url(@icon-url-home);
			}
			&.icon-queue{
				background-image:url(@icon-url-queue);
			}
			&.icon-song{
				background-image:url(@icon-url-song);
			}
			&.icon-settings{
